...
def main() -> None:
    ...
    print(f"removed_hash_like: {summary.get('removed_hash_like_count', 0)}")
    print(f"removed_generic: {summary.get('removed_generic_count', 0)}")
    print(f"removed_generic_yaml_key: {summary.get('removed_generic_yaml_key_count', 0)}")
